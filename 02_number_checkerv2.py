...
# making sure that the input from the user doesn't break the code
# program when they enter something really close to 0
...
elif get_angle < 0.001:
    get_angle = round_decimals_up(get_angle, 3)
